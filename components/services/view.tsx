  ...
  const services = [
    {
      ...
      description: "Création de solutions logicielles en tant que service, scalables et performantes."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-purple-600">
      ...
      description: "Développement d'agents intelligents et systèmes d'automatisation."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 text-purple-600">
      ...
      description: "Conception d'extensions personnalisées pour Chrome, Firefox et autres navigateurs."
    }
  ]
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="bg-gray-50 rounded-xl p-8 service-card transition duration-300">
              <div className="mb-4">
                {service.icon}
              </div>
